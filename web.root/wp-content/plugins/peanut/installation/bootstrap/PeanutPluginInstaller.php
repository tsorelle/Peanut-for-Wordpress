...
class PeanutPluginInstaller
{
    ...
    {
        $this->fileRoot =  ABSPATH;
        $this->pluginRoot = realpath(__DIR__.'/../..');
        $this->configPath = ABSPATH.'/application/config';
    ...
    private function initialize() {
        ...
        if (!class_exists('\Tops\sys\TPath')) {
            ...
            $loader->addPsr4('Tops\wordpress', "$srcRoot/wordpress");
    ...
    public static function install() {
        $instance = new PeanutPluginInstaller();
